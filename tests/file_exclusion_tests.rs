...
async fn test_git_directory_exclusion() {
    ...
    assert!(
        !file_paths_set.contains(".git/objects/somehash"),
        "Should not contain .git/objects/somehash"
    );
...
async fn test_gitignore_exclusion() {
    ...
    assert!(
        !file_paths_set.contains("target/debug.log"),
        "Should not contain target/debug.log"
    );
    assert!(
    ...
    assert!(
        !file_paths_set.contains("application.log"),
        "Should not contain application.log"
    );
